...
<script language="javascript" type="text/javascript">
	   function kiemtra(){
	    ...
	    if(tentuyen==""){
	        ...
	        document.forms['formthemtuyenbus'].gia_SP.focus();
	        return 0;
	        }
	    if(donvidamnhan==""){
...
<div class="tieude">THÊM TUYẾN BUS</div>
	<form name="formthemtuyenbus" method="POST" enctype="multipart/form-data">
		<table class='tablethemtuyenbus'>
	        	<div class="form-group">
	               ...
	               <tr><th>Độ dài tuyến:</th><td><input type="text" name="dodaituyen" class="form-control" placeholder="Nhập độ dài"></td></tr>
	               <tr><th>Loại xe:</th>
				   ...
				   <tr><th>Số chuyến:</th>
	               <td><input type="text" name="sochuyen" class="form-control" placeholder="Nhập số chuyến"></td></tr>
	               ...
	               <td><input type="number" name="giancachchuyen" class="form-control"  placeholder="Nhập thời gian"></td></tr>
	               <tr>
		              <td></td>
		                <td align="center">
